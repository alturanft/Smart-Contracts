...
import {IAlturaExchange} from "./interfaces/IAlturaExchange.sol";
...
contract LooksRareExchange is IAlturaExchange, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    ITransferManagerNFT public transferManagerNFT;
    ...
    event NewTransferManagerNFT(address indexed transferManagerNFT);
    ...
    function initialize(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0x4831d0b4c409e4f1f9d38e4a9c1050b9ea427f276d95f857aab363fefe5b2e60, // keccak256("AlturaExchange")
    ...
    function matchAskWithTakerBidUsingETHAndWETH(
        ...
        if (takerBid.price > msg.value) {
            IERC20Upgradeable(WETH).safeTransferFrom(msg.sender, address(this), (takerBid.price - msg.value));
        } else {
    ...
    /**
     * @notice Update transfer manager NFT
     * @param _transferManagerNFT new transfer manager address
     */
    function updateTransferManagerNFT(address _transferManagerNFT) external onlyOwner {
        require(_transferManagerNFT != address(0), "Owner: Cannot be null address");
        transferManagerNFT = ITransferManagerNFT(_transferManagerNFT);

        emit NewTransferManagerNFT(_transferManagerNFT);
    }
    ...
    function _transferFeesAndFunds(
        ...
        // 1. Protocol fee
        {
            ...
            if ((protocolFeeRecipient != address(0)) && (protocolFeeAmount != 0)) {
                IERC20Upgradeable(currency).safeTransferFrom(from, protocolFeeRecipient, protocolFeeAmount);
        ...
        // 2. Royalty fee
        {
            ...
            if ((royaltyFeeRecipient != address(0)) && (royaltyFeeAmount != 0)) {
                IERC20Upgradeable(currency).safeTransferFrom(from, royaltyFeeRecipient, royaltyFeeAmount);
    ...
    function _transferFeesAndFundsWithWETH(
        ...
        // 1. Protocol fee
        {
            ...
            // Check if the protocol fee is different than 0 for this strategy
            if ((protocolFeeRecipient != address(0)) && (protocolFeeAmount != 0)) {
                IERC20Upgradeable(WETH).safeTransfer(protocolFeeRecipient, protocolFeeAmount);
                finalSellerAmount -= protocolFeeAmount;
            }
        }
        ...
        // 2. Royalty fee
        {
            ...
            // Check if there is a royalty fee and that it is different to 0
            if ((royaltyFeeRecipient != address(0)) && (royaltyFeeAmount != 0)) {
                IERC20Upgradeable(WETH).safeTransfer(royaltyFeeRecipient, royaltyFeeAmount);
                finalSellerAmount -= royaltyFeeAmount;
    ...
    function _transferNonFungibleToken(
        ...
        transferManagerNFT.transferNonFungibleToken(collection, from, to, tokenId, amount);
    }
